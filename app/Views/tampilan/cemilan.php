...
<head>
    ...
    <link rel="stylesheet" href="Engine/styleCem.css">
</head>
...
<body>
    ...
    <section class="isi">
        <center>
            <div class="top"><a href="<?= base_url('landing'); ?>">Beranda </a>><a href="<?= base_url('minuman'); ?>"> <span>Menu Cemilan</span></a>
                <h1>Cemilan Kami</h1>
            </div>
        </center>
        ...
        <div class="container text-center">
            <div class="row row-cols-2 row-cols-lg-4 g-2 g-lg-3">
                <div class="col">
                    <span class="border-bottom"><img src="../Img/french-fries.webp" alt="" class="img-fluid"></span>
                    <br><br>
                    <h4>French Fries</h4>
                    <h5>Rp:000.000</h5>
                </div>
                <div class="col">
                    <span class="border-bottom"><img src="../Img/snack.jpg" alt="" class="img-fluid"></span>
                    <br><br>
                    <h4>Kentang Goreng dan Sosis</h4>
                    <h5>Rp:000.000</h5>
                </div>
                <div class="col">
                    <span class="border-bottom"><img src="../Img/snack2.jpg" alt="" class="img-fluid"></span>
                    <br><br>
                    <h4>Roti Bakar</h4>
                    <h5>Rp:000.000</h5>
                </div>
                <div class="col">
                    <span class="border-bottom"><img src="../Img/Rotikupi.webp" alt="" class="img-fluid"></span>
                    <br><br>
                    <h4>Roti Kupi</h4>
                    <h5>Rp:000.000</h5>
                </div>
