...
<body>
    ...
    <section class="isi">
        <center>
            <div class="top"><a href="<?= base_url('landing'); ?>">Beranda </a>><a href="<?= base_url('minuman'); ?>"> <span>Menu Minuman</span></a>
                <h1>Minuman Kami</h1>
            </div>
        </center>
        ...
        <div class="container text-center">
            <div class="row row-cols-2 row-cols-lg-4 g-2 g-lg-3">
                ...
                <div class="col">
                    <span class="border-bottom"><img src="../Img/green-thai-tea.webp" alt="" class="img-fluid"></span>
                    <br><br>
                    <h4>Green Thai Tea</h4>
                    <h5>Rp:000.000</h5>
                </div>
                <div class="col">
                    <span class="border-bottom"><img src="../Img/es-kopi-susu.webp" alt="" class="img-fluid"></span>
                    <br><br>
                    <h4>Es Kopi Susu</h4>
                    <h5>Rp:000.000</h5>
                </div>
                <div class="col">
                    <span class="border-bottom"><img src="../Img/honey-lemon.webp" alt="" class="img-fluid"></span>
                    <br><br>
                    <h4>Honey Lemon</h4>
                    <h5>Rp:000.000</h5>
                </div>
                <div class="col">
                    <span class="border-bottom"><img src="../Img/iced-choko.webp" alt="" class="img-fluid"></span>
                    <br><br>
                    <h4>Iced Choko</h4>
                    <h5>Rp:000.000</h5>
                </div>
                <div class="col">
                    <span class="border-bottom"><img src="../Img/mocha.webp" alt="" class="img-fluid"></span>
                    <br><br>
                    <h4>Mocha</h4>
                    <h5>Rp:000.000</h5>
                </div>
                <div class="col">
                    <span class="border-bottom"><img src="../Img/Nagen-mixed.webp" alt="" class="img-fluid"></span>
                    <br><br>
                    <h4>Nagen Mixed</h4>
                    <h5>Rp:000.000</h5>
                </div>
                <div class="col">
                    <span class="border-bottom"><img src="../Img/naturan-green.webp" alt="" class="img-fluid"></span>
                    <br><br>
                    <h4>Naturan Green</h4>
                    <h5>Rp:000.000</h5>
                </div>
                <div class="col">
                    <span class="border-bottom"><img src="../Img/ovaltine2.webp" alt="" class="img-fluid"></span>
                    <br><br>
                    <h4>Ovaltine</h4>
                    <h5>Rp:000.000</h5>
                </div>
                <div class="col">
                    <span class="border-bottom"><img src="../Img/royal-mixer.webp" alt="" class="img-fluid"></span>
                    <br><br>
                    <h4>Royal Mixer</h4>
                    <h5>Rp:000.000</h5>
                </div>
                <div class="col">
                    <span class="border-bottom"><img src="../Img/thai-milk.webp" alt="" class="img-fluid"></span>
                    <br><br>
                    <h4>Thai Milk</h4>
                    <h5>Rp:000.000</h5>
                </div>
                <div class="col">
                    <span class="border-bottom"><img src="../Img/thai.webp" alt="" class="img-fluid"></span>
                    <br><br>
                    <h4>Thai</h4>
                    <h5>Rp:000.000</h5>
                </div>
                <div class="col">
                    <span class="border-bottom"><img src="../Img/ultimate mango.webp" alt="" class="img-fluid"></span>
                    <br><br>
                    <h4>Ultimate Mango</h4>
                    <h5>Rp:000.000</h5>
                </div>
                <div class="col">
                    <span class="border-bottom"><img src="../Img/ultimate-mango-(large).webp" alt=""
